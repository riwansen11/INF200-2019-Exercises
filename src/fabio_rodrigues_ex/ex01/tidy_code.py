...
def game(max_attempts):
    """It is a game where you have x-max_attempts 
    to guess right the sum of 2 dice.
    Your score will be the x-max_attempts minus the 
    number of mistakes you had (attempted).
...
def guessed_num():
    """Ask for the user to guess the sum of 2 
    rolled dices.
    """
...
def guess_check(guessed_number, num_to_guess):
    """Check if the guessed number is equal to the 
    number to guess, then returns true or false.
    """
